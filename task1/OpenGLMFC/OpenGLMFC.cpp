...
BEGIN_MESSAGE_MAP(COpenGLMFCApp, CWinAppEx)
...
COpenGLMFCApp::COpenGLMFCApp() noexcept
{
...
// COpenGLMFCApp 自定义加载/保存方法

void COpenGLMFCApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void COpenGLMFCApp::LoadCustomState()
{
}

void COpenGLMFCApp::SaveCustomState()
{
}
